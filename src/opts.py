...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--use_TD_in_backbone', action='store_true',
                                 help='Whether to apply temporal difference module in the backbone.')
        self.parser.add_argument('--use_temp_augmentation', action='store_true',
                                 help='Whether to apply temporal augmentation in the sampler.')
        self.parser.add_argument('--skip_mov', action='store_true',
                                 help='Whether to consider mov branch when regressing box size.')
        ...
        self.parser.add_argument('--arch', default='resnet_18',
                                 help='model architecture. Currently tested'
                                      'resnet_18 | resnet_101 | dla_34 / mobile_v2')
